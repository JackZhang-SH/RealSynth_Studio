...
RS Studio is a Blender add-on for **dataset generation and camera virtualization**. It helps you **import or generate multi-view cameras**, render frames from those cameras, and export datasets in formats commonly used by **NeRF / Instant-NGP / COLMAP / 3D Gaussian Splatting (3DGS)** pipelines.
